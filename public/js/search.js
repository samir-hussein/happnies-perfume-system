            ...
            if (result.length > 0) {
                ...
                `;
                    ...
                    if (result[key].type == "product") {
                        ...
                        rows +=
                            `<td><button data-id="${result[key].code}" data-name="${result[key].name}" data-price="${result[key].priceAfter}" class="btn btn-sm btn-secondary gather-item">تجميع</button></td>`;
                    }
