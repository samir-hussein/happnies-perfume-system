                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <input id="delivery_price" type="number" class="form-control" value="0">
                        </div>
                        <div class="col">
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <textarea id="delivery_place" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col">
                    ...
                    <table class="table table-hover">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="text-right"><span id="delivery_price_td">0</span> جنية</td>
                            </tr>
                            <tr>
                                <td colspan="2" class="text-right w-50">
                                    <button id="pay" class="btn btn btn-info w-100">تسجيل الطلب</button>
                                </td>
                                <td></td>
                                <td colspan="2" class="text-right w-50">
                                    <button id="pay_print" class="btn btn btn-warning w-100">تسجيل الطلب & طباعة</button>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
