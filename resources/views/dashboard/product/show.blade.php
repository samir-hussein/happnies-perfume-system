        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row align-items-center my-3">
                    <div class="col">
                        <h2 class="page-title">بيانات المنتج</h2>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('dashboard.product.update', ['product' => $product->id]) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="description" dir="auto">{{ $product->description }}</textarea>
                                @error('description')
                                    <p style="color: red">* {{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="qty" name="qty" dir="auto"
                                        value="{{ $product->qty->sum('qty') }}" placeholder="0">
                                    @error('qty')
                                        <p style="color: red">* {{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="warning_qty" name="warning_qty"
                                        dir="auto" value="{{ $product->warning_qty }}" placeholder="0">
                                    @error('warning_qty')
                                        <p style="color: red">* {{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="discount" name="discount"
                                        dir="auto" value="{{ $product->discount }}" placeholder="0">
                                    @error('discount')
                                        <p style="color: red">* {{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-control" id="discount_type" name="discount_type">
                                        <option {{ 'ratio' == $product->discount_type ? 'selected' : '' }} value="ratio">
                                            نسبة
                                            مئوية</option>
                                        <option {{ 'amount' == $product->discount_type ? 'selected' : '' }}
                                            value="amount">
                                            مبلغ
                                            مالي (جنية)</option>
                                    </select>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">الكميات المتاحة</strong>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col">
                                <label>هامش الربح</label>
                                <input disabled class="form-control" dir="auto" placeholder="0"
                                    value="{{ $product->profit() }} جنية">
                            </div>
                        </div>
                        @foreach ($product->qty as $qty)
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    ...
                                    <input disabled class="form-control" dir="auto" placeholder="0"
                                        value="{{ $qty->price }} جنية">
                                </div>
                                <div class="col">
                                    <label>السعر الاجمالى</label>
                                    <input disabled class="form-control" dir="auto" placeholder="0"
                                        value="{{ $qty->price * $qty->qty }} جنية">
                                </div>
                                <div class="col">
                                    <label>تاريخ الاضافة</label>
                                    <input disabled class="form-control" dir="auto" placeholder="0"
                                        value="{{ date('Y-m-d H:i a', strtotime($qty->store_date)) }}">
                                </div>
                            </div>
                        @endforeach
                    </div>
